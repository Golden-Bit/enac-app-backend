...
> uvicorn api_contratto_omnia8_fastapi:app_ --reload
> ```
...
from app_.models.client_model import Client
from app_.models.contract_model import ContrattoOmnia8  # modello contratti
...
async def ping():
    """Ritorna *status: ok* se l’app_ è attiva."""
    return {"status": "ok"}
